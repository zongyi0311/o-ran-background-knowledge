...
| :-------------------- | :------------------------------------------------------------------------ |
| **Extendable**        | Building blocks for each 5G domain (CN, RAN, Terminal) → _Modular design_ |
...
| **Intent-driven**     | Files define what you want instead of how to create it → _Declarative_    |
